 ...
 * @author Asus
 */
public class frmUserU extends javax.swing.JInternalFrame {
    ...
    public frmUserU(int empId) {
        this.empId = empId;  // Lưu empId
        initComponents();

        initComponents();
        pack();
        this.setSize(807, 467);
    ...
    public void getUser() {
        try {
            ...
            String query = "SELECT users.userId, users.username, users.password, users.email, "
                    ...
                    + "FROM users WHERE empId = " + this.empId;
    ...
    private void initComponents() {
        ...
        txtEployeesID.setEnabled(false);
